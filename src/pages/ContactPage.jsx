    ...
    <div className="authorities-container" style={{maxWidth: 800, margin: '0 auto', paddingBottom: 48}}>
      ...
      <div style={{fontSize: '1.08rem', marginBottom: 32, lineHeight: 1.7}}>
        ...
        <div style={{marginTop: 12}}>
          e-mail: <a href="mailto:okreg.dls@zhr.pl" style={{color: 'var(--primary)', fontWeight: 600}}>okreg.dls@zhr.pl</a>
        </div>
      </div>
      <div style={{fontSize: '1.08rem', marginBottom: 24, lineHeight: 1.7}}>
        Kontakt z mediami: <a href="mailto:rzecznik.dls@zhr.pl" style={{color: 'var(--primary)', fontWeight: 600}}>rzecznik.dls@zhr.pl</a>, 730 407 770. Więcej informacji <a href="/dla-mediow" style={{color: 'var(--primary)', fontWeight: 600}}>dla mediów</a>
      </div>
    </div>
  );
}
