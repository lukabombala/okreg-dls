...
export default function HoprInfoPage() {
  return (
    <div className="authorities-container" style={{maxWidth: 900, margin: '0 auto', paddingBottom: 48}}>
      <h1 style={{marginBottom: 18}}>Ogólne informacje o HOPR</h1>
      ...
      <div style={{display: 'flex', gap: 32, flexWrap: 'wrap', marginBottom: 18}}>
        <div style={{flex: '2 1 320px', minWidth: 220}}>
          <h2 style={{fontSize: '1.08rem', margin: '18px 0 8px 0', color: '#31491d'}}>Czym się zajmujemy?</h2>
          ...
          <h2 style={{fontSize: '1.08rem', margin: '18px 0 8px 0', color: '#31491d'}}>Kto może dołączyć?</h2>
          <div style={{lineHeight: 1.7}}>
        ...
        <div style={{flex: '1 1 320px', minWidth: 220}}>
          <h2 style={{fontSize: '1.08rem', margin: '18px 0 8px 0', color: '#31491d'}}>Sztab</h2>
          <div style={{lineHeight: 1.7}}>
          ...
          <h2 style={{fontSize: '1.08rem', margin: '18px 0 8px 0', color: '#31491d'}}>Członkowie</h2>
          <div style={{lineHeight: 1.7}}>
          ...
          <h2 style={{fontSize: '1.08rem', margin: '18px 0 8px 0', color: '#31491d'}}>Współpraca</h2>
          <div style={{lineHeight: 1.7}}>
