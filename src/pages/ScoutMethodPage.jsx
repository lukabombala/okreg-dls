...
export default function ScoutMethodPage() {
  return (
    <div className="authorities-container" style={{maxWidth: 900, margin: '0 auto', paddingBottom: 48}}>
      <h1 style={{marginBottom: 18}}>Metoda Harcerska</h1>
      <h2 style={{fontSize: '1.15rem', margin: '32px 0 10px 0', color: '#31491d'}}>Jak działamy w Okręgu Dolnośląskim ZHR</h2>
      ...
      <h2 style={{fontSize: '1.15rem', margin: '32px 0 10px 0', color: '#31491d'}}>Metoda harcerska w praktyce</h2>
      <div style={{marginBottom: 18, lineHeight: 1.7}}>
      ...
      <h2 style={{fontSize: '1.15rem', margin: '32px 0 10px 0', color: '#31491d'}}>Praca śródroczna</h2>
      <div style={{marginBottom: 18, lineHeight: 1.7}}>
      ...
      <h2 style={{fontSize: '1.15rem', margin: '32px 0 10px 0', color: '#31491d'}}>Wypoczynek letni i zimowy</h2>
      <div style={{marginBottom: 18, lineHeight: 1.7}}>
      ...
      <h2 style={{fontSize: '1.15rem', margin: '32px 0 10px 0', color: '#31491d'}}>Kadra i odpowiedzialność na wyjazdach</h2>
      <div style={{marginBottom: 18, lineHeight: 1.7}}>
